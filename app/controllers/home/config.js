...
const configure = () => {
    Alloy.Globals.doLog({
        text: 'configure() quality: ' +Alloy.Globals.videoQuality + ' bitrate: '+Alloy.Globals.videoBitRate,
        program: logProgram
    });      
...
const onApplyClick = () => {
    Alloy.Globals.doLog({
        text: 'onApplyClick() quality: ' +$.qualityRowPicker.getSelectedRow(0).customValue + ' bitrate: '+$.bitrateRowInput.value * 1000,
        program: logProgram
    });     
